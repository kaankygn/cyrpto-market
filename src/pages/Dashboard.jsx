    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div className="rounded-lg border border-gray-200 p-4">
          ...
          <div className="text-sm text-gray-500 mt-1">Toplam piyasa değeri</div>
        </div>
        <div className="rounded-lg border border-gray-200 p-4">
        ...
        <div className="rounded-lg border border-gray-200 p-4">
          ...
          <div className="text-sm text-gray-500 mt-1">24s hacim</div>
        </div>
        <div className="rounded-lg border border-gray-200 p-4">
          <div className="text-2xl font-semibold">{stats.active_cryptocurrencies.toLocaleString()}</div>
          <div className="text-sm text-gray-500 mt-1">Aktif coin</div>
        </div>
      </div>

      <h2 className="text-lg font-semibold mb-3">Trend coinler</h2>
